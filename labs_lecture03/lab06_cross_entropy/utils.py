...
def display_scores(sc):
    ...
    if bs == 2:
        ...
        f.subplots_adjust(
            left=None, bottom=None, right=None, top=None, wspace=None, hspace=0.25
        )
