...
cmap = sns.diverging_palette(
    262, 10, sep=1, n=16, s=99, l=50, center="dark", as_cmap=True
)  # best
...
def check_mnist_dataset_exists(path_data="../../data/"):
    ...
    if (
        flag_train_data == False
        or flag_train_label == False
        or flag_test_data == False
        or flag_test_label == False
    ):
...
def check_fashion_mnist_dataset_exists(path_data="../../data/"):
    ...
    if (
        ...
        trainset = torchvision.datasets.FashionMNIST(
            root=path_data + "fashion-mnist/temp",
            train=True,
            download=True,
            transform=transforms.ToTensor(),
        )
